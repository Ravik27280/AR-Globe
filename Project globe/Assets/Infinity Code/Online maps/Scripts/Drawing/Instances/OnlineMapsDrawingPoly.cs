...
public class OnlineMapsDrawingPoly : OnlineMapsDrawingElement
{
    ...
    public override void DrawOnTileset(OnlineMapsTileSetControl control, int index)
    {
        ...
        if (Math.Abs((v1 - v2).magnitude) < float.Epsilon)
        {
            ...
            s1 = OnlineMapsUtils.GetIntersectionPointOfTwoLines(v0.x, v0.z, v1.x, v1.z, vs4.x, vs4.z, vs3.x, v3.z, out nv1.x, out nv1.z);
            s2 = OnlineMapsUtils.GetIntersectionPointOfTwoLines(v3.x, v3.z, v2.x, v2.z, vs1.x, vs1.z, vs2.x, v2.z, out nv2.x, out nv2.z);

            //Vector3 nv2 = OnlineMapsUtils.GetIntersectionPointOfTwoLines(v1, v2, vs2, vs3, out s2);
