...
public class OnlineMapsPanoConnector : MonoBehaviour
{
    ...
    {
        foreach (OnlineMapsTile tile in OnlineMapsTile.tiles) SetOverlay(tile as OnlineMapsRasterTile, null);
    ...
    private void OnEnable()
    {
        ...
        foreach (KeyValuePair<ulong, Texture2D> pair in overlays)
        {
            ...
            SetOverlay(OnlineMapsTile.dTiles[pair.Key] as OnlineMapsRasterTile, pair.Value);
        }
