...
public class ExampleTextToSpeech : MonoBehaviour
{
    ...
    string _testString = "<speak version=\"1.0\"><prosody pitch=\"100Hz\">Welcome To indian space research orgnization</prosody></speak>";  // Test string which you can initialize with any phrase or sentence.
    ...
    private void Update()
    {
        ...
        {
            case 1:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">Hello there! What can i do for you.</prosody></speak>";  // Jarvis you there?
                Runnable.Run(Jarvis()); // Execute the TTS engine.
                SpeakState = 0;
                break;
            case 2:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">ISRO was formed in 1969 with a vision to develop and harness space technology in national development, while pursuing planetary exploration and space science research. ISRO replaced its predecessor, INCOSPAR (Indian National Committee for Space Research), established in 1962 by India’s first Prime Minister Pt. Jawaharlal Nehru and scientist Vikram Sarabhai, considered amongst the founding fathers of Indian space program.</prosody></speak>"; // Bring up design interface
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            case 3:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">sure, With pleasure.</prosody></speak>"; // open up project edith prototype
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            case 4:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">missions done by ISRO are ,Chandrayaan 1 at 22 October 2008, Chandrayaan 2 at 22 July 2019, Mars Orbiter Mission at 5 November 2013 and many more</prosody></speak>"; // pause rotation || continue
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            case 5:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">The major missions are Chandrayaan 3 at 2021, Gaganyaan at 2021, Lunar Polar Exploration Mission at 2024.</prosody></speak>"; // Jarvis bring up status
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            case 6:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">I am Vikram AI based AR Assistant Developed by Team Techno files 1 for ISRO.</prosody></speak>"; // Integrate deadshot module
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            case 7:
                ...
                break;
            case 8:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">bye bye nice to meet you, have a good day.</prosody></speak>"; // Jarvis activate edith protocol
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            case 9:
                _testString = "<speak version=\"1.0\"><prosody pitch=\"110Hz\">ok! as your wish.</prosody></speak>"; // yeah, seems good idea
                Runnable.Run(Jarvis());
                SpeakState = 0;
                break;
            //case 10:
    ...
    public static IEnumerator I1_HelloVikram()  // Coroutines which sets the state machine. Each one cooresponds to the case statement above.
    {
        Debug.Log("Hello");
        SpeakState = 1;
    ...
    public static IEnumerator I2_History()
    {
        Debug.Log("history");
        SpeakState = 2;
        Debug.Log("SpeakState" + SpeakState);
    ...
    public static IEnumerator I4_mission()
    {
        Debug.Log("missions");
        SpeakState = 4;
        Debug.Log("SpeakState" + SpeakState);
    ...
    public static IEnumerator I5_Upcoming()
    {
        Debug.Log("upcoming");
        SpeakState = 5;
        Debug.Log("SpeakState" + SpeakState);
    ...
    public static IEnumerator I6_Who()
    {
        Debug.Log("who");
        SpeakState = 6;
        Debug.Log("SpeakState" + SpeakState);
